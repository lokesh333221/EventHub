...
function EventManagement() {
  ...
  return (
    <div className="space-y-6 p-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { label: "Total Events", val: totals.events, icon: <Calendar className="h-4 w-4 text-blue-600" />,className:"bg-gradient-to-br from-emerald-50 to-emerald-100 border-emerald-200 hover:shadow-lg transition-all duration-300" },
          {
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-between items-center">
            ...
            <div className="flex gap-3 w-full lg:w-auto">
              <Select value={cat} onValueChange={setCat}>
                ...
                <SelectContent>
                  <SelectItem className="data-[highlighted]:bg-primary data-[highlighted]:text-white"
 value="all">All Categories</SelectItem>
 ...
 key={category} value={category}>
              ...
              <Select value={status} onValueChange={setStatus}>
                ...
                <SelectContent>
                  <SelectItem value="all" className="data-[highlighted]:bg-primary data-[highlighted]:text-white"
>All Status</SelectItem>
                  <SelectItem value="delayed" className="data-[highlighted]:bg-primary data-[highlighted]:text-white"
>Delayed</SelectItem>
                  <SelectItem value="Upcoming" className="data-[highlighted]:bg-primary data-[highlighted]:text-white"
>Upcoming</SelectItem>
                  <SelectItem value="completed" className="data-[highlighted]:bg-primary data-[highlighted]:text-white"
>Completed</SelectItem>
                  <SelectItem value="cancelled" className="data-[highlighted]:bg-primary data-[highlighted]:text-white"
>Cancelled</SelectItem>
      ...
      {/* events list */}
      {!loading && filtered.length > 0 && (
        <Tabs value={view} onValueChange={(v) => setView(v as "grid" | "table")} className="overflow-hidden">
          {/* GRID ------------------------------------------------------------- */}
